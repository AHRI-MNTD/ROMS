        ...
        children: [
          { index: true, element: <Navigate to="/domains/hr/recruitment-onboarding" replace /> },
          {
            ...
            children: [
              ...
              { path: "personnel-registration", element: <TrainingRecordsPage /> },
              { path: "training-records", element: <Navigate to="/domains/hr/recruitment-onboarding/personnel-registration" replace /> },
