      ...
      prisma.staffProfile.upsert({
        ...
        create: {
          ...
          jobTitle: [
            ...
            "researcher_ii",
            "division_head",
            "junior_administration_officer",
            "assistant_researcher_i",
            "project_accountant",
            "researcher_i",
          ][i],
          ...
          sex: ["male", "female", "male", "female", "male", "female", "male", "female"][i],
          personalEmail: `user${i + 1}@gmail.com`,
          ahriEmail: i % 2 === 0 ? `user${i + 1}.demo@ahri.gov.et` : null,
          phone: `09${String(12345670 + i)}`,
          emergencyContact: `Emergency Contact ${i + 1} - 09${String(98765430 - i)}`,
          mntdProject: [null, "achides", null, null, null, "cease", "dpp", null][i],
          mntdTeams: i < 4 ? ["Laboratory_Team", "Data_Team"] : ["Field_Team"],
          mntdProjectsInvolved: i < 3 ? ["ACHIDES_(Dr._Fitsum)", "CEASE_(Dr._Endalamaw)"] : ["SHARP_(Dr._Endalamaw)"],
          firstDegree: ["Biology", "Computer Science", "Public Health", "Microbiology", "Management", "Chemistry", "Statistics", "Nursing"][i],
          firstDegreeUniv: ["addis_ababa_university", "jimma_university", "hawassa_university", "bahir_dar_university", "mekelle_university", "arba_minch_university", "university_of_gondar", "dilla_university"][i],
          firstDegreeYear: ["2015", "2016", "2014", "2013", "2017", "2018", "2019", "2016"][i],
          secondDegree: i < 4 ? ["MSc Parasitology", "MSc Data Science", "MPH", "PhD Microbiology"][i] : null,
          secondDegreeUniv: i < 4 ? ["addis_ababa_university", "other", "jimma_university", "addis_ababa_university"][i] : null,
          secondDegreeUnivOther: i === 1 ? "London School of Hygiene and Tropical Medicine" : null,
          secondDegreeYear: i < 4 ? ["2018", "2019", "2017", "2020"][i] : null,
          thirdDegree: i === 3 ? "PhD Molecular Biology" : null,
          thirdDegreeUnivCountry: i === 3 ? "University of Oxford, UK" : null,
          thirdDegreeYear: i === 3 ? "2023" : null,
          currentlyStudying: i === 6,
          studyMastersField: i === 6 ? "Biostatistics" : null,
          studyMastersUniv: i === 6 ? "Addis Ababa University" : null,
          studyMastersYear: i === 6 ? "2027" : null,
          totalWorkExp: ["more_than_5_years", "3_to_4_years", "more_than_5_years", "more_than_5_years", "1_to_2_years", "2_to_3_years", "less_than_1_year", "4_to_5_years"][i],
          totalWorkExpAhri: ["4_to_5_years", "2_to_3_years", "more_than_5_years", "more_than_5_years", "less_than_1_year", "1_to_2_years", "less_than_1_year", "3_to_4_years"][i],
          propertyInventory: i < 4 ? {
            desktop_computer: { quantity: 1, brand: "Dell OptiPlex" },
            laptop_computer: { quantity: 1, brand: "HP ProBook" },
            computer_screen: { quantity: i < 2 ? 2 : 1, brand: "Samsung" },
          } : null,
        } as any,
      })
    )
