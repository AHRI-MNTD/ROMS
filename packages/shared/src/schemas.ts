...
export const CreateStaffProfileSchema = z.object({
  ...
  ahriEmail: z.string().optional().nullable(),
  mntdProject: z.string().optional().nullable(),
  mntdTeams: z.array(z.string()).optional().default([]),
  mntdProjectsInvolved: z.array(z.string()).optional().default([]),
  firstDegree: z.string().optional().nullable(),
  firstDegreeUniv: z.string().optional().nullable(),
  firstDegreeUnivOther: z.string().optional().nullable(),
  firstDegreeYear: z.string().optional().nullable(),
  secondDegree: z.string().optional().nullable(),
  secondDegreeUniv: z.string().optional().nullable(),
  secondDegreeUnivOther: z.string().optional().nullable(),
  secondDegreeYear: z.string().optional().nullable(),
  thirdDegree: z.string().optional().nullable(),
  thirdDegreeUnivCountry: z.string().optional().nullable(),
  thirdDegreeYear: z.string().optional().nullable(),
  currentlyStudying: z.boolean().optional().nullable(),
  studyMastersField: z.string().optional().nullable(),
  studyMastersUniv: z.string().optional().nullable(),
  studyMastersYear: z.string().optional().nullable(),
  studyPhdField: z.string().optional().nullable(),
  studyPhdUniv: z.string().optional().nullable(),
  studyPhdYear: z.string().optional().nullable(),
  studyCertField: z.string().optional().nullable(),
  studyCertUniv: z.string().optional().nullable(),
  studyCertYear: z.string().optional().nullable(),
  totalWorkExp: z.string().optional().nullable(),
  totalWorkExpAhri: z.string().optional().nullable(),
  propertyInventory: z.any().optional().nullable(),
});
